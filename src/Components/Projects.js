            ...
            <S.Section>
                ...
                <S.DivOne>
                    <div>
                        ...
                        <div>
                            <a href="https://github.com/danie11z/Watchill" title="Repositório" target="_blank">
                                <S.ImgTwo src={GitLogo} alt="Logo do Github" />
                            </a>
                            <a href="https://watchill-531g.vercel.app/filmes" title="Deploy" target="_blank">
                                <S.ImgTwo src={VercelLogo} alt="Logo do Vercel" />
                            </a>
                        </div>
                    </div>
            ...
            <S.Section>
                ...
                <S.DivOne>
                    <div>
                        ...
                        <div>
                            <a href="https://github.com/danie11z/Pets" title="Repositório" target="_blank">
                                <S.ImgTwo src={GitLogo} alt="Logo do Github" />
                            </a>
                            <a href="https://pets-three.vercel.app/" title="Deploy" target="_blank">
                                <S.ImgTwo src={VercelLogo} alt="Logo do Vercel" />
                            </a>
                        </div>
                    </div>
